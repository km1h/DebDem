...
import { fetchWorld, fetchAllQuestions } from '../database/Fetch';
import { World, Question } from '../database/Structures';
...
const WorldPage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    loadWorldData();
    fetchAllQuestions().then(questions => setPosts(questions))
  });
